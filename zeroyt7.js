...
creator = 'Gant' // GAK USAH DI UBAH ANJING HARGA CREATOR
recode = 'Gant' // UBAH NAMA LU
...
const daftar2 = 'Jangan Lupa Subscribe Zero YT7\nhttps://youtube.com/ZeroYT7'
...
JANGAN LUPA SUBSCRIBE YOUTUBE GANT BOTZ
https://youtube.com/ZeroYT7
`
...
but = [
        ...
        sendButImage(from, teks, "©Gant Botz", gam, but)
break
...
sendButton(from, "GOPAY : qris aja ke owner (GANTOD)", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "DANA : 085701338390 (gantsesi)", faketeks, but, mek)
break
case 'ovo':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "OVO : 081252011524 (GANTOD)", faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
but = [
        ...
        sendButImage(from, kimak, "©GantBotz", gam, but)
break
case 'donasi':
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Gopay : https://l.top4top.io/p_21282fcg00.jpg
❍┤ヅ Dana : 085701338390
❍┤ヅ Ovo : 081252011524
❍┤ヅ Pulsa : 082192943105
    ╰───────────────❏`
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
        ...
        sendButImage(from, teks, "©GantBotz", gam, but)
break
